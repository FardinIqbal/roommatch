...
ActiveRecord::Schema[7.1].define(version: 2025_04_29_183534) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "pets"
    t.boolean "verified"
    t.text "filter_keywords"
    t.boolean "filter_same_school", default: false
    t.boolean "filter_smoking"
    t.boolean "filter_clean"
    t.string "filter_sleep"
